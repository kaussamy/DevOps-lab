...
To complete this module, you will be using  SAM Local. By now you should have SAM local set up, if not refer to main README.md and complete the pre-requisites.
